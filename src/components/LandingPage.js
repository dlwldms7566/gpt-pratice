...
export default function LandingPage({ isSidebarOpen }) {
    return (
        <div className={styles.container}>
            <div className={`${styles.green} ${isSidebarOpen ? styles.sidebarOpen : ""}`}>
                <img className={styles.green_img}
            ...
            <div className={`${styles.intro_fullcontainer} ${isSidebarOpen ? styles.SidebarOpen : ""}`}>
            ...
            <div className={`${styles.smalltext_container} ${isSidebarOpen ? styles.SidebarOpen : ""}`}>
            ...
            <div className={`${styles.Buillt_container} ${isSidebarOpen ? styles.SidebarOpen : ""}`}>
            ...
            <div className={`${styles.bigtext_fullcontainer} ${isSidebarOpen ? styles.SidebarOpen : ""}`}>
                <div className={styles.bigtext_container}>
                    ...
                    <div>
                        <div className={styles.twobuttons}>
                            <a href="https://chatgpt.com/" target="_blank" rel="noreferrer" style={{ textDecoration: "none" }}>
            ...
            <div className={`${styles.footer_container} ${isSidebarOpen ? styles.SidebarOpen : ""}`}>
                ...
                <div className={styles.footer_bottom}>
                    <div className={styles.footer_sns}>
                        <a className={styles.sns_element} href="https://x.com/OpenAI" target="_blank" rel="noreferrer">
                        ...
                        <a className={styles.sns_element} href="https://www.youtube.com/OpenAI" target="_blank" rel="noreferrer">
                        ...
                        <a className={styles.sns_element} href="https://www.linkedin.com/company/openai" target="_blank" rel="noreferrer">
                        ...
                        <a className={styles.sns_element} href="https://github.com/openai" target="_blank" rel="noreferrer">
                        ...
                        <a className={styles.sns_element} href="https://www.instagram.com/openai/?hl=en" target="_blank" rel="noreferrer">
                        ...
                        <a className={styles.sns_element} href="https://www.tiktok.com/@openai?lang=en" target="_blank" rel="noreferrer">
